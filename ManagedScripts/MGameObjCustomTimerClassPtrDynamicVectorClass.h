...
namespace RenSharp
{
	public ref class GameObjCustomTimerClassPtrDynamicVectorClass : public DynamicVectorClass<IntPtr>
	{
		private:
			GameObjCustomTimerClassPtrDynamicVectorClass();
			GameObjCustomTimerClassPtrDynamicVectorClass(int size);

		public:
			GameObjCustomTimerClassPtrDynamicVectorClass(IntPtr pointer);

			static IUnmanagedContainer<IDynamicVectorClass<IntPtr> ^> ^CreateGameObjCustomTimerClassPtrDynamicVectorClass();
			static IUnmanagedContainer<IDynamicVectorClass<IntPtr> ^> ^CreateGameObjCustomTimerClassPtrDynamicVectorClass(int size);
			...
			property IntPtr GameObjCustomTimerClassPtrDynamicVectorClassPointer
			{
				IntPtr get();
			}
		...
		protected:
			...
			property ::DynamicVectorClass<::GameObjCustomTimerClass *> *InternalGameObjCustomTimerClassPtrDynamicVectorClassPointer
			{
				virtual ::DynamicVectorClass<::GameObjCustomTimerClass *> *get();
			}
