...
class DAVehicleQueueGameFeatureClass;

#pragma managed(pop)

namespace RenSharp
{
	public interface class IDAVehicleQueueGameFeatureClass : public IDAEventClass, public IDAGameFeatureClass
	{
		property IntPtr DAVehicleQueueGameFeatureClassPointer
		{
			IntPtr get();
		}
	};

	public ref class DAVehicleQueueGameFeatureClass : public DAEventClass, public IDAVehicleQueueGameFeatureClass
	{
		private:
			IDAGameFeatureClass^ daGameFeatureClass;

		public:
			DAVehicleQueueGameFeatureClass(IntPtr pointer);
		...
		protected:
			...
			property ::DAVehicleQueueGameFeatureClass* InternalDAVehicleQueueGameFeatureClassPointer
			{
				virtual ::DAVehicleQueueGameFeatureClass* get();
			}
	};
}