...
namespace RenSharp
{
	...
	public ref class Vector3PtrDynamicVectorClass : public DynamicVectorClass<Vector3>
	{
		private:
			Vector3PtrDynamicVectorClass();
			Vector3PtrDynamicVectorClass(int size);

		public:
			Vector3PtrDynamicVectorClass(IntPtr pointer);

			static IUnmanagedContainer<IDynamicVectorClass<Vector3>^>^ CreateVector3PtrDynamicVectorClass();
			static IUnmanagedContainer<IDynamicVectorClass<Vector3>^>^ CreateVector3PtrDynamicVectorClass(int size);
			...
			property IntPtr Vector3PtrDynamicVectorClassPointer
			{
				IntPtr get();
			}
		...
		protected:
			...
			property ::DynamicVectorClass<::Vector3*>* InternalVector3PtrDynamicVectorClassPointer
			{
