...
namespace RenSharp
{
	...
	::GenericMultiListClass* BuildingAggregateClassRefMultiListClass::InternalGenericMultiListClassPointer::get()
	{
		return InternalBuildingAggregateClassRefMultiListClassPointer;
	}
