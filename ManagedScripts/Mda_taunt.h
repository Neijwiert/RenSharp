...
class DATauntsGameFeatureClass;

#pragma managed(pop)

namespace RenSharp
{
	public interface class IDATauntsGameFeatureClass : public IDAEventClass, public IDAGameFeatureClass
	{
		property IntPtr DATauntsGameFeatureClassPointer
		{
			IntPtr get();
		}
	};

	public ref class DATauntsGameFeatureClass : public DAEventClass, public IDATauntsGameFeatureClass
	{
		private:
			IDAGameFeatureClass^ daGameFeatureClass;

		public:
			DATauntsGameFeatureClass(IntPtr pointer);
		...
		protected:
			...
			property ::DATauntsGameFeatureClass* InternalDATauntsGameFeatureClassPointer
			{
				virtual ::DATauntsGameFeatureClass* get();
			}
	};
}