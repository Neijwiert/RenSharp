...
namespace RenSharp
{
	SoldierFactoryGameObj::SoldierFactoryGameObj(IntPtr pointer)
	...
	{
		return InternalSoldierFactoryGameObjPointer;
	}

	::CombatPhysObserverClass *SoldierFactoryGameObj::InternalCombatPhysObserverClassPointer::get()
	{
		return InternalSoldierFactoryGameObjPointer;
	}

	::BuildingGameObj *SoldierFactoryGameObj::InternalBuildingGameObjPointer::get()
	{
		return InternalSoldierFactoryGameObjPointer;
	}

	::SoldierFactoryGameObj *SoldierFactoryGameObj::InternalSoldierFactoryGameObjPointer::get()
	{
		return reinterpret_cast<::SoldierFactoryGameObj *>(Pointer.ToPointer());
	}
}