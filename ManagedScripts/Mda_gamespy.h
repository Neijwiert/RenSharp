...
class DAGameSpyGameFeatureClass;

#pragma managed(pop)

namespace RenSharp
{
	public interface class IDAGameSpyGameFeatureClass : public IDAEventClass, public IDAGameFeatureClass
	{
		property IntPtr DAGameSpyGameFeatureClassPointer
		{
			IntPtr get();
		}
	};

	public ref class DAGameSpyGameFeatureClass : public DAEventClass, public IDAGameSpyGameFeatureClass
	{
		private:
			IDAGameFeatureClass^ daGameFeatureClass;

		public:
			DAGameSpyGameFeatureClass(IntPtr pointer);
		...
		protected:
			...
			property ::DAGameSpyGameFeatureClass* InternalDAGameSpyGameFeatureClassPointer
			{
				virtual ::DAGameSpyGameFeatureClass* get();
			}
	};
}