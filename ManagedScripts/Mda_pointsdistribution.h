...
class DAPointsDistributionGameFeatureClass;

#pragma managed(pop)

namespace RenSharp
{
	public interface class IDAPointsDistributionGameFeatureClass : public IDAEventClass, public IDAGameFeatureClass
	{
		property IntPtr DAPointsDistributionGameFeatureClassPointer
		{
			IntPtr get();
		}
	};

	public ref class DAPointsDistributionGameFeatureClass : public DAEventClass, public IDAPointsDistributionGameFeatureClass
	{
		private:
			IDAGameFeatureClass^ daGameFeatureClass;

		public:
			DAPointsDistributionGameFeatureClass(IntPtr pointer);
		...
		protected:
			...
			property ::DAPointsDistributionGameFeatureClass* InternalDAPointsDistributionGameFeatureClassPointer
			{
				virtual ::DAPointsDistributionGameFeatureClass* get();
			}
	};
}