...
namespace RenSharp
{
	public ref class WideStringClassDynamicVectorClass : public DynamicVectorClass<String ^>
	{
	private:
		WideStringClassDynamicVectorClass();
		WideStringClassDynamicVectorClass(int size);

	public:
		WideStringClassDynamicVectorClass(IntPtr pointer);

		static IUnmanagedContainer<IDynamicVectorClass<String ^> ^> ^CreateWideStringClassDynamicVectorClass();
		static IUnmanagedContainer<IDynamicVectorClass<String ^> ^> ^CreateWideStringClassDynamicVectorClass(int size);
		...
		property IntPtr WideStringClassDynamicVectorClassPointer
		{
			IntPtr get();
		}
	...
	protected:
		...
		property ::DynamicVectorClass<::WideStringClass> *InternalWideStringClassDynamicVectorClassPointer
		{
			virtual ::DynamicVectorClass<::WideStringClass> *get();
		}
